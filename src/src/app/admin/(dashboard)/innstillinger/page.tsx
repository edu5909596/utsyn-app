...
export default function InnstillingerPage() {
  ...
  return (
    <>
      ...
      {/* Prices & Contact */}
      <div className="admin-form-section">
        <h3>Priser og kontakt</h3>
        <div className="admin-form-grid">
          <div className="form-group">
            <label className="form-label">Pris hovedrett (kr)</label>
            <input className="form-input" type="number" value={settings.price_main || ''} onChange={e => updateSetting('price_main', e.target.value)} />
          </div>
          <div className="form-group">
            <label className="form-label">Pris dessert (kr)</label>
            <input className="form-input" type="number" value={settings.price_dessert || ''} onChange={e => updateSetting('price_dessert', e.target.value)} />
          </div>
          <div className="form-group">
